...
4. Add the Android `google-services.json` and Android `FirebaseOptions` before Android release builds.
5. Generate platform folders if this scaffold is checked out without them:
